...
namespace csvm{
   ...
   class MLPerceptron{
	  ...
	  //helpMethods:
		...
		void setMaxActivation(vector<double>& maxOutputActivation,vector<double> currentActivation);
	  //feedforward:
   ...
   public:
	  ...
	  void returnOutputActivation(vector<Feature> imageFeatures,vector<double>& maxOutputActivation);
